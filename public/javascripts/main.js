...
},{"./data/TimelineData":6,"./data/TimelineDataAlt":7,"./data/WizardConfig":8,"./data/WizardContent":9,"./routers/Router":16,"./views/HomeView":35,"./views/InputItemView":36,"./views/LoginView":37,"./views/OutputView":38}],6:[function(require,module,exports){
var TimelineData;
...
module.exports = OutputView = (function(_super) {
  ...
  OutputView.prototype.updateBuild = function(build) {
    ...
    return console.log(this.currentBuild);
  };
...
var DetailsTemplate, GradingTemplate, OptionsTemplate, TimelineView, View, WizardStepInputs, application,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = TimelineView = (function(_super) {
  ...
  TimelineView.prototype.renderResult = function() {
    ...
    this.$outContainer.append(DetailsTemplate(WizardStepInputs));
    _.each(this.outWiki, (function(_this) {
      return function(item, index) {
        var extra, isLastWeek, nextWeek, thisWeek, titles;
        thisWeek = index + 1;
        nextWeek = index + 2;
        isLastWeek = index === _this.out.length - 1;
        if (item.title.length > 0) {
    ...
    this.$outContainer.append(GradingTemplate(WizardStepInputs));
    this.$outContainer.append(OptionsTemplate(WizardStepInputs));
...
},{"../app":5,"../data/WizardStepInputs":11,"../templates/steps/output/CourseDetailsTemplate.hbs":29,"../templates/steps/output/CourseOptionsTemplate.hbs":30,"../templates/steps/output/GradingTemplate.hbs":31,"../views/supers/View":44}],43:[function(require,module,exports){
