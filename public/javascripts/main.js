...
module.exports = TimelineView = (function(_super) {
  ...
  TimelineView.prototype.length = 16;
  ...
  TimelineView.prototype.updateTimeline = function() {
    var diff, newCourse, newDate, newLength, timeline, w;
    ...
    if (this.start_date.value !== '' && this.end_date.value !== '') {
      ...
      if (this.totalBlackoutWeeks > 0) {
        ...
        if (newLength < 6) {
          ...
          newCourse = this.getWikiWeekOutput(this.length);
        }
      }
    }
    this.update();
  ...
  TimelineView.prototype.update = function() {
    ...
    console.log(this.length, this.outWiki);
    this.renderResult();
  ...
  TimelineView.prototype.renderResult = function() {
    var addWeeks, curWeekOffset, gradingItems;
    ...
    if (application.homeView.selectedPathways[0] === 'researchwrite') {
      ...
      _.each(this.outWiki, (function(_this) {
        return function(item, index) {
          var extra, isLastWeek, nextWeek, noClassThisWeek, thisWeek, titles;
          thisWeek = index + 1;
          nextWeek = index + 2;
          isLastWeek = index === _this.out.length - 1;
