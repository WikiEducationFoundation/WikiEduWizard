...
module.exports = TimelineView = (function(_super) {
  ...
  TimelineView.prototype.initialize = function() {
    ...
    $('.recreate').on('click', (function(_this) {
      return function(e) {
        e.preventDefault();
  ...
  TimelineView.prototype.renderResult = function() {
    ...
    return _.each(this.out, function(item, index) {
      return $('.output-container').append("<div>" + (index + 1) + ". " + item.title + "</div>");
    });
  };
