...
module.exports = InputItemView = (function(_super) {
  ...
  InputItemView.prototype.checkButtonClickHandler = function() {
    var $inputItem;
    $inputItem = this.$el.find('input');
    if ($inputItem.is(':checked')) {
      $inputItem.prop('checked', false);
      return $inputItem.trigger('change');
    } else {
