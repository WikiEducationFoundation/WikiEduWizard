...
module.exports = TimelineView = (function(_super) {
  ...
  TimelineView.prototype.initialize = function() {
    ...
    this.units = _.where(this.data, {
      type: "week"
    });
    this.breaks = _.where(this.data, {
      type: "break"
    });
    $('.whatever').on('click', (function(_this) {
      return function(e) {
        e.preventDefault();
  ...
  TimelineView.prototype.clickHandler = function(e) {
    ...
    this.courseDiff = this.units.length - this.courseLength;
    return this.update();
  };
  ...
  TimelineView.prototype.update = function() {
    ...
    return _.each(out, function(item, index) {
