...
module.exports = InputItemView = (function(_super) {
  ...
  InputItemView.prototype.checkButtonClickHandler = function() {
    this.$el.toggleClass('checked');
    if (this.$el.hasClass('checked')) {
      console.log('yup');
      this.$inputEl.prop('checked', true);
      console.log(this.$inputEl.prop('checked'));
      console.log(this.$inputEl.is(':checked'));
      this.$inputEl.val('on');
...
},{"../templates/OutputTemplate.hbs":18,"../views/supers/View":26}],24:[function(require,module,exports){
