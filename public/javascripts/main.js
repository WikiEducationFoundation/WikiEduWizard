...
module.exports = TimelineView = (function(_super) {
  ...
  TimelineView.prototype.renderResult = function() {
    var currentBlackoutDates, gradingItems;
          ...
          if (item.title.length > 0) {
            ...
            if (_this.allDates.length > 0) {
              ...
              if (currentBlackoutDates.length > 0) {
                titles += "| nomeeting = ";
                _.each(currentBlackoutDates, function(boDate, boIndex) {
                  if (boIndex === currentBlackoutDates.length - 1) {
                    return titles += "" + boDate + " ";
                  } else {
                    return titles += "" + boDate + ", ";
                  }
                });
