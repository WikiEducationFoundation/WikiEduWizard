...
},{"./data/TimelineData":6,"./data/TimelineDataAlt":7,"./data/WizardContent":9,"./routers/Router":16,"./views/HomeView":33,"./views/InputItemView":34,"./views/LoginView":35,"./views/OutputView":36,"./views/TimelineView":39}],6:[function(require,module,exports){
var TimelineData;
...
TimelineDataAlt = [
  {
    ...
    assignments: ['Add to an article', 'Illustrate an article', 'List article choices', 'Choose articles from a list', 'Evaluate article selections | due = Week 5'],
    milestones: [],
    readings: []
  }, {
    type: 'break',
...
},{"../app":5,"../data/WizardStepInputs":11,"../templates/steps/modules/WikiDatesModule.hbs":25}],32:[function(require,module,exports){
...
},{"../app":5,"../data/WizardStepInputs":11,"../templates/steps/modules/WikiGradingModule.hbs":26,"../views/supers/View":41}],33:[function(require,module,exports){
...
},{"../app":5,"../data/WizardStepInputs":11,"../models/StepModel":14,"../templates/HomeTemplate.hbs":17,"../templates/steps/output/WikiOutputTemplate.hbs":30,"../views/StepNavView":37,"../views/StepView":38,"../views/supers/View":41}],34:[function(require,module,exports){
...
},{"../views/supers/InputView":40}],35:[function(require,module,exports){
...
},{"../app":5,"../data/WizardContent":9,"../templates/LoginTemplate.hbs":18,"../views/supers/View":41}],36:[function(require,module,exports){
...
},{"../app":5,"../data/WizardStepInputs":11,"../templates/steps/output/CourseDetailsTemplate.hbs":27,"../templates/steps/output/CourseOptionsTemplate.hbs":28,"../templates/steps/output/GradingTemplate.hbs":29,"../templates/steps/output/WikiOutputTemplate.hbs":30,"../views/supers/View":41}],37:[function(require,module,exports){
...
},{"../app":5,"../templates/StepNavTemplate.hbs":19,"../views/supers/View":41}],38:[function(require,module,exports){
...
},{"../app":5,"../data/WizardAssignmentData":8,"../data/WizardCourseInfo":10,"../data/WizardStepInputs":11,"../templates/steps/IntroStepTemplate.hbs":20,"../templates/steps/StepTemplate.hbs":21,"../templates/steps/info/CourseTipTemplate.hbs":22,"../templates/steps/info/InputTipTemplate.hbs":23,"../templates/steps/modules/WikiDatesModule.hbs":25,"../views/DateInputView":31,"../views/GradingInputView":32,"../views/InputItemView":34,"../views/supers/View":41}],39:[function(require,module,exports){
...
module.exports = TimelineView = (function(_super) {
  ...
  TimelineView.prototype.updateWeeklyDates = function() {
    ...
    weekOfDate = this.getWeekOfDate(startDate);
    ...
    $('span.date.date-1').show().text(this.getFormattedDateString(startDate));
    this.$startDate.val("" + (this.getFormattedDateString(startDate)));
    $('.dates-preview').html('');
  ...
  TimelineView.prototype.onCourseEndChange = function(e) {
    this.sDate = '';
    this.eDate = '';
    this.$startDate.val('').attr('min', '').attr('max', '');
    return this.$endDate.val('').attr('min', '').attr('max', '');
  };

  TimelineView.prototype.onStartDateChange = function(e) {
    var diff, maxEndDate, maxEndDateText, maxEndDay, maxEndMonth, minEndDate, minEndDateText, minEndDay, minEndMonth;
    if (this.$startDate.val() === '') {
      return;
    }
    this.sDate = new Date(this.$startDate.val());
    this.$endDate.val('');
    minEndDate = this.getWeeksOutDate(this.sDate, 6);
    maxEndDate = this.getWeeksOutDate(this.sDate, 16);
    if (maxEndDate.getUTCDay() > 0 && maxEndDate.getUTCDay() < 6) {
      diff = 6 - maxEndDate.getUTCDay();
      maxEndDate.setDate(maxEndDate.getDate() + diff);
    }
    if (minEndDate.getUTCDate().toString().length === 1) {
      minEndDay = "0" + minEndDate.getUTCDate().toString();
    } else {
      minEndDay = minEndDate.getUTCDate().toString();
    }
    if (maxEndDate.getUTCDate().toString().length === 1) {
      maxEndDay = "0" + maxEndDate.getUTCDate().toString();
    } else {
      maxEndDay = maxEndDate.getUTCDate().toString();
    }
    if ((minEndDate.getUTCMonth() + 1).toString().length === 1) {
      minEndMonth = "0" + (minEndDate.getUTCMonth() + 1).toString();
    } else {
      minEndMonth = (minEndDate.getUTCMonth() + 1).toString();
    }
    if ((maxEndDate.getUTCMonth() + 1).toString().length === 1) {
    ...
    this.$endDate.attr('min', "" + minEndDateText);
    this.$endDate.attr('max', "" + maxEndDateText);
    return this;
  };

  TimelineView.prototype.onEndDateChange = function(e) {
    var prevCourseLength, tempCourseLength;
    if (this.$endDate.val() === '') {
      return;
    }
    prevCourseLength = this.courseLength;
    this.eDate = new Date(this.$endDate.val());
    tempCourseLength = Math.ceil((this.eDate - this.sDate) / (1000 * 7 * 24 * 60 * 60));
    if (!tempCourseLength) {
    ...
    if (tempCourseLength < 6 || tempCourseLength > 16) {
      ...
      this.courseLength = tempCourseLength;
      this.courseDiff = 16 - this.courseLength;
      $('#courseLengthReadout').val(this.courseLength);
      if (this.courseLength !== prevCourseLength) {
        this.update();
      }
    }
    return this;
...
},{"../app":5,"../views/supers/View":41}],40:[function(require,module,exports){
...
},{"../../app":5,"../../data/WizardAssignmentData":8,"../../data/WizardStepInputs":11,"../../templates/steps/inputs/InputItemTemplate.hbs":24,"./View":41}],41:[function(require,module,exports){
var View,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
