...
module.exports = TimelineView = (function(_super) {
  ...
  TimelineView.prototype.onTermStartDateChange = function(e) {
    var dateInputVal, dateMoment, dateObject, defaultEndDate, defaultEndDateString;
    ...
    defaultEndDate = this.getWeeksOutDate(dateObject, this.defaultCourseLength);
    defaultEndDateString = this.toString(defaultEndDate);
    this.$courseStartDate.val(this.toString(dateObject)).trigger('change');
    this.$termEndDate.val(defaultEndDateString);
    return this.update();
  };
  ...
  TimelineView.prototype.onCourseStartDateChange = function(e) {
    var dateInput, defaultEndDate, defaultEndDateString, newDate;
    dateInput = $(e.currentTarget).val();
    newDate = moment(dateInput).toDate();
    WizardData.intro.wizard_start_date.value = dateInput;
    WizardData.course_details.start_date = dateInput;
    defaultEndDate = this.getWeeksOutDate(newDate, this.defaultCourseLength);
    defaultEndDateString = this.toString(defaultEndDate);
    this.courseLength = this.defaultCourseLength;
    this.courseDiff = 0;
    ...
    this.update();
    return this.$courseEndDate.val(defaultEndDateString).trigger('change');
  };
