...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class=\"custom-input-grading\">\n\n  <div class=\"custom-input-grading-summary\">\n\n    <div class=\"custom-input-grading__total\">Total</div>\n\n    <div class=\"custom-input-grading__percent\">100%</div>\n\n  </div>\n  \n  <div class=\"custom-input-grading-selection\">\n    <h3>Grading based on:</h3>\n    <div class=\"custom-input-grading-selection-form\">\n      <div class=\"custom-input-wrapper\">\n        <div class=\"custom-input custom-input--radio custom-input--radio-group\">\n          <a class=\"radio-button\" href=\"#\"></a>\n          <label for=\"percent\">Percentage</label>\n          <input name=\"grading-selection\" id=\"percent\" value=\"percent\" type=\"radio\" />\n        </div>\n        <div class=\"custom-input custom-input--radio custom-input--radio-group\">\n          <a class=\"radio-button\" href=\"#\"></a>\n          <label for=\"points\">Points</label>\n          <input name=\"grading-selection\" id=\"points\" value=\"points\" type=\"radio\" />\n        </div>\n      </div>\n    </div>\n  </div>\n\n\n\n</div>";
  })
...
var GradingInputView, View, WikiGradingModule, application,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"../App":5,"../templates/steps/modules/WikiGradingModule.hbs":24,"../views/supers/View":35}],28:[function(require,module,exports){
...
module.exports = StepView = (function(_super) {
  ...
  StepView.prototype.afterRender = function() {
    ...
    console.log('stepview', this.model.attributes.id);
    if (this.model.attributes.id === 'grading') {
      this.gradingView = new GradingInputView();
      this.$el.find('.step-form-content').append(this.gradingView.render().el);
    }
    return this;
  };
